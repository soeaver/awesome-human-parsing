...
|------|:-----------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------:|
| 2013 |    TMM     | [Fashion parsing with weak color-category labels](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6630093)|--|
| 2014 |    CVPR     | [Towards unified human parsing and pose estimation](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6909508)|--|
| 2015 |    ICCV     | [Human parsing with contextualized convolutional neural network](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7423822)|[Project](https://github.com/lemondan/HumanParsing-Dataset/)|
| 2015 |    TMM     | [Fashion parsing with video context](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7120998)|--|
| 2015 |    TPAMI     | [Deep human parsing with active template regression](https://arxiv.org/pdf/1503.02391)|--|
| 2016 |    AAAI     | [Pose-guided human parsing by an and/or graph using pose-context features](https://arxiv.org/pdf/1508.03881)|--|
| 2016 |    CVPR     | [Attention to scale: Scale-aware semantic image segmentation](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7780765)|[code]( http://liangchiehchen.com/projects/DeepLab.html)|
| 2016 |    CVPR     | [Semantic object parsing with local-global long short-term memory](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7780716)|--|
| 2016 |    ECCV     | [Semantic object parsing with graph lstm](https://arxiv.org/pdf/1603.07063)|--|
| 2016 |    ECCV     | [Zoom better to see clearer: Human and object parsing with hierarchical auto-zoom net](https://arxiv.org/pdf/1511.06881)|--|
| 2016 |    TMM      | [Clothes coparsing via joint image segmentation and labeling with application to clothing retrieval](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7434660)|[Project](http://vision.sysu.edu.cn/projects/clothing-co-parsing/)|
| 2017 |    CVPR     | [Interpretable structure-evolving lstm](https://arxiv.org/pdf/1703.03055)|--|
| 2017 |    CVPR     | [Look into person: Self-supervised structure-sensitive learning and a new benchmark for human parsing](https://arxiv.org/pdf/1703.05446v2)|[Code](https://github.com/Engineering-Course/LIP_SSL),[Project](http://hcp.sysu.edu.cn/lip)|
| 2017 |    CVPRW    | [Self-supervised neural aggregation networks for human parsing](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8014938)|--|
| 2017 |    PG       | [Transferring pose and augmenting background variation for deep human image parsing](https://diglib.eg.org/bitstream/handle/10.2312/pg20171317/007-012.pdf)|--|
| 2017 |    BMVC     | [Real-time factored convnets: Extracting the x factor in human parsing](http://www.bmva.org/bmvc/2017/papers/paper024/paper024.pdf)|--|
| 2018 |    AAAI     | [Progressive cognitive human parsing](https://www.aaai.org/ocs/index.php/AAAI/AAAI16/paper/download/12206/12140)|--|
| 2018 |    AAAI     | [Cross-domain human parsing via adversarial feature and label adaptation](https://arxiv.org/pdf/1801.01260)|--|
| 2018 |    CVPR     | [Weakly and semi supervised human body part parsing via pose-guided knowledge transfer](https://arxiv.org/pdf/1805.04310.pdf)|--|
| 2018 |    MM       | [Trusted guidance pyramid network for human parsing](https://dl.acm.org/doi/pdf/10.1145/3240508.3240634)|[Code](https://github.com/suzhuoi/TGPnet)|
| 2018 |    ICME     | [Finer-net: Cascaded human parsing with hierarchical granularity](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8486505)|--|
| 2018 |    ECCV     | [Mutual learning to adapt for joint human parsing and pose estimation](https://openaccess.thecvf.com/content_ECCV_2018/papers/Xuecheng_Nie_Mutual_Learning_to_ECCV_2018_paper.pdf)|--|
| 2018 |    ECCV     | [Macromicro adversarial network for human parsing](https://arxiv.org/pdf/1807.08260)|[Code](https://github.com/RoyalVane/MMAN)|
| 2018 |    TPAMI    | [Look into person: Joint body parsing pose estimation network and a new benchmark](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8327922)|[Project](http://www.sysu-hcp.net/lip/)|
...
| 2019 |    CVPR     | [Graphonomy: Universal human parsing via graph transfer learning](https://arxiv.org/pdf/1904.04536)|[Code](https://github/)|
| 2019 |    ICCV     | [Learning compositional neural information fusion for human parsing](https://arxiv.org/pdf/2001.06804)|[Code](https://github.com/ZzzjzzZ/CompositionalHumanParsing)|
| 2019 |    ICCV     | [Multi-class part parsing with joint boundary-semantic awareness](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9010738)|--|
| 2019 |    ICCV     | [Spgnet: Semantic prediction guidance for scene parsing](https://openaccess.thecvf.com/content_ICCV_2019/papers/Cheng_SPGNet_Semantic_Prediction_Guidance_for_Scene_Parsing_ICCV_2019_paper.pdf)|--|
| 2019 |    MM       | [Braidnet: Braiding semantics and details for accurate human parsing](https://dl.acm.org/doi/pdf/10.1145/3343031.3350857)|--|
| 2019 |    ICIP     | [Improving human parsing by extracting global information using the non-local operation](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8804412)|--|
| 2019 |    IVC      | [Keypoint based weakly supervised human parsing](https://arxiv.org/pdf/1809.05285v1.pdf)|--|
...
| 2021 |    NeuCom   | [Mvsn: A multi-view stack network for human parsing](https://www.sciencedirect.com/science/article/pii/S0925231221013357/pdfft?md5=651a1c3e86e74de43e076622d43bbee3&pid=1-s2.0-S0925231221013357-main.pdf)|--|
